...
App.SynopsisTemplates = {
    ...
    'Romance': [
        ...
        "Werewolves are everywhere! But what's a plucky {character1} to do when a dashing were-{character2} shows up at {location1} High School? Romance can't help but erupt between {character1} and {character2}, brought together by a mutual interest in antique {prop1}, when they team up to repel a horde of haunted {prop2} sent from {location2} by the nefarious {sidekick2}.",
    ...
    'Sci-Fi': [
        ...
        "{character1} gets cut by a radioactive {prop2}, and now {character1} turns into {character2} whenever their body gets wet!  Soon, {character1} develops feelings for {sidekick2}, while {character2} is more interested in {sidekick1}. Can they learn to live together in the same body, sharing the same {prop1}, as they navigate life in {location1}?",
        "{character1} and {character2} are twins that are the results of an experiment that would allow for the perfect child. {character1} was planned and grows to athletic proportions. {character2} is an accident and is somewhat smaller in stature. {character2} is placed in an orphanage while {character1} is taken to a {location1} island and raised by {sidekick1}. {character2} becomes the ultimate lowlife and is about to be killed by {sidekick2} for stealing {prop2} when {character1} discovers that a twin exists and begins searching. "
    ],
    'Sports': [
        "{character1} grew up on the wrong side of {location1}, and when the high school's basketball team is merged with {location2}'s team, tensions rise.  {character2} is selected to be the new team's captain, and must rise to the challenge when top-scorer {sidekick2} is paralyzed by an errant {prop2}.",
