...
App.SynopsisTemplates = {
    ...
    'drama': [
        ...
        "{location1} is invaded by intruders! The {character1} was able to drive out the enemy without a problem. {character2} experiences the true intensity of the {prop1} for the first time and is thrilled about it.",
        "{character1} is tasked with writing copy for {prop1}, a device that claims to help women lose weight. Meanwhile, {character2} pulls {sidekick1} out of his sick leave to rebuild confidence with their client {sidekick2} who has become overly concerned about {sidekick1}'s absence.",
    ],
    'horror': [
        ...
        "When {character1} finds his pupils begin to perish in terrible ways at the hands of {character2}, he calls on friend {sidekick2} to prevent further bloodshed by uncovering the secret of the {prop1}, rumored to be hidden somewhere in {location2}.",
    ...
    'mystery': [
        ...
        "After following {character1} to {location1} with the {prop1}, {character2} and {sidekick2} make a surprising discovery about {sidekick1}, who has been working as a skilled secret agent",
        "When {character1} wins a trip to {location2}'s famous opera, he invites {sidekick2} and {sidekick1} to attend the epic event. However, when the mysterious {character2} threatens to ruin the show, the gang needs to draw on clues like the disappearance of the {prop1} and {prop2} to solve the case.",
        "When the severed head of {sidekick2} is found in {location1}, it's up to {character1}, a police sergant with 15 years of experience, and {character2}, the rookie, to solve the case. After finding a {prop2} at the crime scene that leads them to {location2}, it's discovered that {sidekick2} was the mastermind all along."
    ],
    'police procedural': [
        ...
        "{character1} and {sidekick2} learn the theft of a Japanese {prop2} is more complex than it first seems, while {character2} and {sidekick1} investigate the death of a teenager who believed she was a {prop1}"
    ],
    'romance': [
    ...
    'romantic comedy': [
        ...
        "Because of an old family feud, {character1} and {character2} have taken to extremes their fight over who has truly the best pizza. The situation is about to come to a head when {character1} discovers the {prop2} missing, while {sidekick1} and {sidekick2} begin a secret romance.",
    ],
    'sci-fi': [
